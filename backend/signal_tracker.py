...
SIGNALS_FILE = os.path.join(ROOT_DIR, "data", "signals.json")
DECISIONS_FILE = os.path.join(ROOT_DIR, "data", "DECISIONS.md")
ERRORS_FILE = os.path.join(ROOT_DIR, "data", "ERRORS.md")
...
You are AegisAgent's Signal Evolution Tracker. Analyze HOW signals are evolving between cycles.
